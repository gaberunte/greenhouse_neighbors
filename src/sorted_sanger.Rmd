...
tips.dec21 = read_csv(here("data", "destructive_tips/desttips_inventoried.csv")) %>% 
  mutate(set = "Dec21")
tips.jan22 = read_csv(here("data", "destructive_tips/desttips_inventoried_jan21.csv")) %>% 
  mutate(set = "Jan22") 
tips.feb22 = read_csv(here("data", "destructive_tips/desttips_inventoried_feb22.csv")) %>% 
  mutate(set = "Feb22") 
