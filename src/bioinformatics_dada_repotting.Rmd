...
```{r, message=FALSE}
path <- here("sequencing", "repotting_destructive_tips", "fastqs")
```
...
write.csv(taxa, file=here("data", "taxa_tips.csv") )
taxa.tib = read_csv(here("data", "taxa_tips.csv")) 
taxa.tib = taxa.tib %>% 
  names(taxa.tib)[1] = "sequence"

write.csv(taxa, here("data", "unite_roottip_dectructive_otus.csv"))
...
save.image(here("data", "sept13.RData"))
