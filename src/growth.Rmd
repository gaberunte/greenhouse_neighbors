...
t7 = read_csv(here("data", "measurements_april2022.csv")) %>% 
  clean_names() %>% 
  rename(additional_height = add_height)%>% 
  mutate(timepoint = "7")%>% 
  mutate(month = lubridate::my(042022))

t8 = read_csv(here("data", "Neighbor seedlings measurements 7_26_22 - Sheet1.csv")) %>% 
  clean_names() %>% 
  mutate(timepoint = "8")%>% 
...
```{r}
ggplot(photo_data %>% 
         filter(seedling_sp == "P"), aes(x= soil_type,y= above_area_cm2, fill = soil_type )) + 
  geom_boxplot()+
  scale_fill_manual(
...
ggsave(here("figures", "t1_bigcone_size.pdf"))

ggplot(photo_data %>% 
         filter(seedling_sp == "Q"), aes(x= soil_type,y= above_area_cm2, fill = soil_type )) + 
  geom_boxplot()+
  scale_fill_manual(
    values = c("darkseagreen4", "darkgoldenrod2", "cadetblue3" ), name = "Soil Type",
    breaks = c("P", "Q", "C"), labels = c("Bigcone", "Canyon Oak", "Control"))+
...
ggplot(photo_data %>% 
         filter(seedling_sp == "P"), aes(x= soil_type,y= root_shoot, fill = soil_type )) + 
  geom_boxplot()+
  scale_fill_manual(
    values = c("darkseagreen4", "darkgoldenrod2", "cadetblue3" ), name = "Soil Type",
    breaks = c("P", "Q", "C"), labels = c("Bigcone", "Canyon Oak", "Control"))+
  ...
  labs(title = "Bigcone root:shoot ratio",
       y= "Root:shoot ratio")
ggsave(here("figures", "t1_bigcone_rootshoot.pdf"))

ggplot(photo_data %>% 
         filter(seedling_sp == "Q"), aes(x= soil_type,y= root_shoot, fill = soil_type )) + 
  geom_boxplot()+
  scale_fill_manual(
    values = c("darkseagreen4", "darkgoldenrod2", "cadetblue3" ), name = "Soil Type",
    breaks = c("P", "Q", "C"), labels = c("Bigcone", "Canyon Oak", "Control"))+
...
ggplot(master7 %>% 
    ...
    geom_boxplot(aes(x = neighb.soil, y = change.length
, fill = neighb.spp)) +
    facet_wrap(~seedling_sp)+
  scale_fill_manual(
    values = c("darkseagreen4", "darkgoldenrod2"), name = "Neighbor species",
...
ggplot(bigcone, aes(y = rel.growth, x = n_soil_long, fill = n_soil_long, color= n_soil_long)) +
  geom_boxplot(alpha = .5) +
  geom_jitter(alpha = .5, width = .25) +
  facet_grid(rows=vars(n_sp_long), cols = vars(soil_long )) +
  labs(
...
ggplot(oaks, aes(y = change.ht, x = n_soil_long, fill = n_soil_long, color= n_soil_long)) +
  geom_boxplot(alpha = .5) +
  geom_jitter(alpha = .5, width = .25) +
  facet_grid(rows=vars(n_sp_long), cols = vars(soil_long ))+
  labs(
...
ggplot(bigcone, aes(y = comp_growth, x = n_soil_long, fill = n_soil_long, color= n_soil_long)) +
  geom_boxplot(alpha = .5) +
  geom_jitter(alpha = .5, width = .25) +
  facet_grid(rows=vars(n_sp_long), cols = vars(soil_long ))
...
ggplot(master4 %>% 
         filter(seedling_sp == "P"), aes(soil_type, height_cm, fill = soil_type)) +
  geom_boxplot()

ggplot(master4 %>% 
         filter(seedling_sp == "Q"), aes(soil_type, height_cm, fill = soil_type)) +
  geom_boxplot()

ggplot(master4 %>% 
         filter(seedling_sp == "P"), aes(soil_type, diameter_mm, fill = soil_type)) +
  geom_boxplot()

ggplot(master4 %>% 
         filter(seedling_sp == "Q"), aes(soil_type, diameter_mm, fill = soil_type)) +
  geom_boxplot()
```
...
ggplot(m3 %>% 
         filter(seedling_sp == "P"), aes(soil_type, height_cm, fill = soil_type)) +
  geom_boxplot()
plot(lm(log(height_cm)~soil_type, data = m3 %>% filter(seedling_sp == "P")))
TukeyHSD(aov(lm(log(height_cm)~soil_type, data = m3 %>% filter(seedling_sp == "P"))))

ggplot(m3 %>% 
         filter(seedling_sp == "Q"), aes(soil_type, height_cm, fill = soil_type)) +
  geom_boxplot()

plot(lm(log(height_cm)~soil_type, data = m3 %>% filter(seedling_sp == "Q")))
TukeyHSD(aov(lm(log(height_cm)~soil_type, data = m3 %>% filter(seedling_sp == "Q"))))
