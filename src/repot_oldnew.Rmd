...
```{r, message = F}
folder = "data/sanger_data/repot_oldnew"
...
python /Users/Gabe/Desktop/phd/FUNGuild-master/Guilds_v1.1.py -otu /Users/Gabe/Desktop/phd/ghecto/data/sanger_data/repot_oldnew/taxa_funguild.txt
```
...
ggplot(view_set %>% 
  ...
  scale_fill_manual(breaks = c("No Amp", "Bad Seq", "Cenococcum", "Peziza",
                               "Pustularia", "Rhizopogon", "Suillus", "Tuber"),
                    values = c("azure3", "azure4", "firebrick2", "darkorange2", "gold2", "palegreen4", "steelblue", "mediumpurple"))+ facet_wrap(~soil_type, scales = "free")
