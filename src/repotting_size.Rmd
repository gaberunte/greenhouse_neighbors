...
#created object "data frame" class() tells what type data.frame, vector,or matrix 
#here brings to top of proj folder, into data, look for this file
seedling_size = read_csv(here("data", "ghecto_repotting_seedling_data.csv")) %>% 
  mutate(timepoint = "3")
#create new varbiale t=3 in data set
t3 = read_csv(here("data", "ghecto_repotting_seedling_data.csv")) %>% 
  mutate(timepoint = "3")

#from the grow up in year 1 before repotting
#created data frame through data folder and seedling measurement fil
