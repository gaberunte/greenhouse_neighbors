...
unite.ref <- here("data", "sh_general_release_dynamic_all_10.05.2021.fasta")
...
write.csv(destructive.taxonomy, here("data", "destructive_tips_20_2021.csv"))
destructive.taxonomy$sequence <- rownames(destructive.taxonomy)
destructive.taxonomy.tib = tibble(destructive.taxonomy)
```
...
```
```{r}
unite.ref = (here("unite_db", "sh_general_release_dynamic_s_10.05.2021.fasta"))
